 ...
 *  under the License.
 */
package me.sunlan.groovy.util

class GPropertiesTest extends GroovyTestCase {
    void testImportProperties() {
        def gp = new GProperties()
        gp.load(GPropertiesTest.getResourceAsStream('/me/sunlan/groovy/util/gproperties.properties'))

        assert '/me/sunlan/groovy/util/gproperties_import.properties,/me/sunlan/groovy/util/gproperties_import3.properties' == gp.getProperty('import.properties')
    ...
    void testConstructor() {
        def gp = new GProperties(new InputStreamReader(GPropertiesTest.getResourceAsStream('/me/sunlan/groovy/util/gproperties.properties')))

        assert 'Hello' == gp.getProperty('greeting.word')
    }

    void testConstructor2() {
        def gp = new GProperties(GPropertiesTest.getResourceAsStream('/me/sunlan/groovy/util/gproperties.properties'))

        assert 'Hello' == gp.getProperty('greeting.word')
    }

    void testConstructor3() {
        def gp = new GProperties(new Properties(['property.missing': 'Missing']), new InputStreamReader(GPropertiesTest.getResourceAsStream('/me/sunlan/groovy/util/gproperties.properties')))

        assert 'Missing' == gp.getProperty('property.missing')
    }

    void testConstructor4() {
        def gp = new GProperties(new Properties(['property.missing': 'Missing']), GPropertiesTest.getResourceAsStream('/me/sunlan/groovy/util/gproperties.properties'))
